    ...
    <div className="min-h-screen bg-white dark:bg-background pb-24">
      ...
      {categoryWiki && (
        <section className="container mx-auto px-4 mb-8 pt-20">
          ...
          {/* Sub-categories (THE MISSING PIECE) */}
          {categoryWiki.children && categoryWiki.children.length > 0 && (
            <div className="mb-12">
              <h3 className="text-lg font-bold mb-6 px-2 text-slate-700 dark:text-slate-300 uppercase tracking-widest text-[10px]">Sub-Categories</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {categoryWiki.children.map((child: any) => (
                  ...
                  >
                    <div className="relative aspect-square w-full bg-white dark:bg-card border border-black/5 dark:border-white/10 rounded-2xl shadow-sm overflow-hidden p-4 flex items-center justify-center group-hover:border-primary/50 transition-all">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest text-center line-clamp-2 group-hover:text-primary transition-colors">
                      {child.title}
                    </span>
                  </button>
                ))}
          ...
          <h2 className="text-2xl font-black mb-8 px-2 uppercase tracking-tighter">Guides</h2>
          ...
          <div className="space-y-12">
            {isLoading ? (
              ...
              <>
                {/* 1. Replacement Guides */}
                {sections.replacement.length > 0 && (
                  <div>
                    <h3 className="text-sm font-bold mb-6 px-2 text-slate-700 dark:text-slate-300 border-l-4 border-primary pl-4">Replacement Guides</h3>
                ...
                {sections.teardowns.length > 0 && (
                  <div className="mt-12">
                    <h3 className="text-sm font-bold mb-6 px-2 text-slate-700 dark:text-slate-300 border-l-4 border-primary pl-4">Teardowns</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                {sections.techniques.length > 0 && (
                  <div className="mt-12">
                    <h3 className="text-sm font-bold mb-6 px-2 text-slate-700 dark:text-slate-300 border-l-4 border-primary pl-4">Techniques</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                {globalGuides.length === 0 && !isLoading && !categoryWiki.children?.length && (
      ...
      {!selectedCategory && (
        <>
          ...
          <section className="container mx-auto px-6 space-y-24 mt-12">
            {!searchQuery && (
              <div className="py-12">
