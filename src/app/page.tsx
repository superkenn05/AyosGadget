        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          {PRIMARY_CATEGORIES.map((cat) => (
            <Link key={cat.name} href={`/guides?category=${cat.name}`}>
              <div className="glass group relative overflow-hidden rounded-[2.5rem] p-6 md:p-8 flex flex-col items-start justify-start transition-all hover:border-primary/50 hover:bg-primary/5 active:scale-95 shadow-xl border-primary/10 h-40 md:h-48">
                {/* Icon at Top Left */}
